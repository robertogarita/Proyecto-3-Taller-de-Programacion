...
class game():
    global font1, font2
    #Iniciar el pygame font
    pygame.font.init()
    # Load test fonts for future use 
    font1 = pygame.font.SysFont("comicsans", 40) 
    font2 = pygame.font.SysFont("comicsans", 30) 
    def __init__(self, weithd= 500, height= 580):
        """
        La primera funcion es el constructor
    ...
    def draw_box(self): 
        for i in range(2): 
            pygame.draw.line(self.screen, (255, 0, 0), (x * dif-3, (y + i)*dif), (x * dif + dif + 3, (y + i)*dif), 7) 
            pygame.draw.line(self.screen, (255, 0, 0), ( (x + i)* dif, y * dif ), ((x + i) * dif, y * dif + dif), 7)    
    ...
    def raise_error2(self): 
        text1 = font1.render("Error !!! Tecla no valida", 1, (0, 0, 0)) 
        self.screen.blit(text1, (20, 570))   
    ...
    def instruction(self): 
        text1 = font2.render("Presione D para resetear/ R para Limpiar", 1, (0, 0, 0)) 
    ...
    def iniciar(self):
        """
        La funcion iniciar sirve para iniciar la partida y es la más importante del juego
        No recibe parametros
        """
        global dif, x, y, thick, grid, val, flag1, flag2, rs,error
        dif = 500 / 9
        x = 0
        thick= 0
        y = 0
        ...
        while self.exit:
            ...
            if val != 0:             
                ...
                # print(x) 
                # print(y) 
                if self.valid(grid, int(x), int(y), val)== True: 
